...
public class VDSOperationParser {

    public static VDSOperation parse(VDS vds, String str) {
        ...
        // return
        return new VDSOperation(methodName, arguments);
    }

    private VDSOperationParser() {}
}
